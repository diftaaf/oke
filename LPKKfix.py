...
if selected_content == "Home":
    ...
    with col1 :
        st.write("Konfigurasi elektron adalah susunan atau gambaran yang menunjukan penempatan elektron dalam suatu atom. Susunan elektron-elektron tersebut berdasarkan kulit atau orbital. Melalui Konfigurasi Elektron kita dapat mengetahui golongan dan periode dari suatu atom. Golongan tersebut ditunjukkan oleh jumlah elektron terluar (elektron valensi), dan periode ditunjukkan oleh nomor kulit terbesar pada isi elektron (kulit terluar). Konfigurasi ini menekankan pada kebolehjadian ditemukan elektron pada tingkat subkulit atom. Di tingkat subkulit, terdapat orbital yaitu tempat yang mungkin ditempati oleh elektron. Orbital dibagi menjadi empat, yaitu orbital s, p, d, dan f.")
        st.write("a. Prinsip Aufbau, Menurut prinsip ini pengisian elektron harus dimulai dari subkulit dengan tingkat energi paling rendah. ")
        st.write("b. Larangan Pauli, Larangan ini menyatakan bahwa dalam satu atom, tidak ada elektron yang memiliki bilangan kuantum sama. Jika dua elektron berada di orbital yang sama, pasti spin keduanya berbeda.")
        st.write("c. Kaidah Hund, Pengisian elektron pada orbital dengan tingkat energi yang sama harus didistribusikan secara merata, dimulai dari elektron yang tidak berpasangan. Setelah semua orbital berisi penuh elektron yang tidak berpasangan, barulah diisi elektron lain dengan spin yang berbeda arah, sehingga membentuk pasangan elektron.")
        st.write("d. Aturan setengah penuh, Aturan ini berkaitan dengan kestabilan suatu unsur. Pada beberapa unsur, elektron cenderung mengalami perpindahan orbital agar lebih stabil.")
